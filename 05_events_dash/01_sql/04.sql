...
SELECT
  ...
  ARRAY_AGG(CASE WHEN DATE_DIFF(DATE(b.purchase_date), DATE(cb.end_date), DAY) BETWEEN 0 AND 180 THEN STRUCT(DATE(b.purchase_date) AS purchase_date, b.retail_price_chf_c AS price) END IGNORE NULLS) AS sales_details
