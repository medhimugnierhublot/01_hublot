-- ================================
-- Transactions YTD to snapshot (2025-01-01 .. 2025-09-01)
-- ================================
WITH tx_2025 AS (
  SELECT
...
-- ================================
-- Snapshot of accounts (Sept 1, 2025) with residency market
-- ================================
snapshot_accounts AS (
  SELECT
    ...
    ah.status,
    ap.gender_pc,
    ah.market AS market,   -- ✅ use residency market directly
    (
...
-- ================================
-- Accounts grouped by residency market (ah.market)
-- ================================
segmented AS (
  SELECT
    s.market,
  ...
  GROUP BY s.market, s.life_time_segment
),
